		...
		<div class="wrapper">
			 <div class="top-nav">
						...
						<ul id="nav">
							 ...
							 <li><a href="index.php#section-3"  onclick="javascript:window.open('index.php#section-3','_self')">                             India Holidays</a></li>
                        	<li><a href="category.php" onclick="javascript:window.open('category.php','_self')">
                        	                              Category</a></li>                             
