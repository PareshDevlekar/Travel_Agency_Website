...
<html>
<head>
<title>My-Tour: Best Tours & Travels Agency in India</title>
...
<div id="portfolio" class="portfolio">
   <div class="top-tours-head text-center">
		  <h3>Trending Indian Destinations</h3>
		      ...
		      <div class="cards">
		        ...
		        <div class="card">
		          <div class="card_image">
		            <img src="images/card_images/Goa.jpg">
		          </div>
		        ...
		        <div class="card">
		          <div class="card_image">
		            <img src="images/card_images/Himachal.jpg">
		          </div>
		          <div class="card_title title-white">
		            <p>Himachal</p>
		          </div>
		        ...
		        <div class="card">
		          <div class="card_image">
		            <img src="images/card_images/Kerala.jpg">
		          </div>
		          <div class="card_title title-white">
		            <p>Kerala</p>
		          </div>
		        ...
		        <div class="card">
		          <div class="card_image">
		            <img src="images/card_images/Mumbai.webp">
		          </div>
		          <div class="card_title title-white">
		            <p>Mumbai</p>
		          </div>
		        ...
		        <div class="card">
		          <div class="card_image">
		            <img src="images/card_images/Rajasthan.jpeg">
		          </div>
		          <div class="card_title title-white">
		            <p>Rajasthan</p>
		          </div>
		        ...
		        <div class="card">
		          <div class="card_image">
		            <img src="images/card_images/Kolkata.jpg">
		          </div>
		          <div class="card_title title-white">
		            <p>Kolkata</p>
		          </div>
		        ...
		        <div class="card">
		          <div class="card_image">
		            <img src="images/card_images/Karnataka.jpg">
		          </div>
		          <div class="card_title title-white">
		            <p>Karnataka</p>
		          </div>
...
<?php }?>
	...
	<div class="col-md-3 image-grid">
					 <img src="Admin/addverimages/<?php echo $data[3]; ?>" width="250px" height="150px" >
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">My-Tour Enterprises</h4>
						...
						<h5 style="color:#000"><span class="img3"></span>1100 High Street, Model Town Thane.</h5>
                        <br/>
